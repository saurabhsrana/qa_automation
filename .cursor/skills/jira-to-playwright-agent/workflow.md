...
- [ ] Decide: extend existing POM vs add methods to existing class — never `ExamplePage` or SauceDemo for Revance
- [ ] Note selector style: role / label / placeholder first; no absolute xpath, no `waitForTimeout`
